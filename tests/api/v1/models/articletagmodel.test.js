...
describe('ArticleTag model', () => {
  ...
  describe('Instance methods', () => {
    describe('when new articleTag is created', () => {
      let articleTag;
      before(() => {
        articleTag = new ArticleTag();
      });
      it('should have all specifed fields', () => {
        expect(articleTag).to.haveOwnProperty('article_tag_id');
        expect(articleTag).to.haveOwnProperty('article_id');
        expect(articleTag).to.haveOwnProperty('tag_id');
      });
    });
  });
